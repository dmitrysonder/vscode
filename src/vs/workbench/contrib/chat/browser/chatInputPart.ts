...
import { PromptInstructionsAttachmentsWidget } from './attachments/promptInstructionsAttachment.js';
...
export class ChatInputPart extends Disposable implements IHistoryNavigationWidget {
	...
	public getAttachedAndImplicitContext(sessionId: string): IChatRequestVariableEntry[] {
		...
		for (const uri of this.promptInstructionAttachmentsPart.references) {
			contextArr.push({
	...
	public get hasPromptInstructionsAttachment(): boolean {
		...
		return !this.promptInstructionAttachmentsPart.empty;
	}
	 ...
	 * TODO: @legomushroom
	 */
	private promptInstructionAttachmentsPart: PromptInstructionsAttachmentsWidget;
	...
	constructor(
		...
		this.promptInstructionAttachmentsPart = this._register(
			instantiationService.createInstance(
				PromptInstructionsAttachmentsWidget,
	...
	private async renderAttachedContext() {
		...
		dom.setVisibility(Boolean(attachments.length) || Boolean(this.implicitContext?.value) || !this.promptInstructionAttachmentsPart.empty, this.attachedContextContainer);
		...
		this.promptInstructionsAttached.set(!this.promptInstructionAttachmentsPart.empty);
		container.appendChild(this.promptInstructionAttachmentsPart.domNode);
