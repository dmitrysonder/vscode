...
export namespace ChatContextKeys {
	...
	export const promptInstructionsAttached = new RawContextKey<boolean>('chatPromptInstructionsAttached', false, { type: 'boolean', description: localize('chatPromptInstructionsAttachedContextDescription', "True when the chat has a prompt instructions attached.") });
